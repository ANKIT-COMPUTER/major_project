...
import com.example.ankitmart.databinding.ActivityProductDetailBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.addToCartBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(ProductDetailActivity.this, "Successfully added", Toast.LENGTH_SHORT).show();
            }
        });
    }
